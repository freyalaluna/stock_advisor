...
allStockWindows = totalStockHistory.withColumns({"end_date": sf.date_add("date", 30), "window": sf.collect_list(totalStockHistory.high).over(timeframe)}) \
                                   .withColumn("seven_day_target", sf.lead(totalStockHistory.high, 37).over(seven_after))
